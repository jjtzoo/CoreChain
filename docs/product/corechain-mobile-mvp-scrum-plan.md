...
- **Still to do:** check the run, photo and new-project/new-hole screens on the phone, and light mode; a bottom tab bar (Home, Photo, Samples, Export) is designed but not built; the bagging action; the same care for empty states and the settings, codes and export screens.
