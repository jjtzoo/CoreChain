...
- **Not yet checked:** the "No photos yet" empty-state redesign was verified in code and against the established samples-list pattern, but not clicked through live on the phone.
